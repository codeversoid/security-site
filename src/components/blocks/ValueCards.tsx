  ...
  return (
    <section className="mx-auto max-w-[1200px] px-4 md:px-8 xl:px-12 py-16 lg:py-24">
      <div className="mb-6 md:mb-8">
        <p className="text-sm font-medium tracking-wide text-amber-300">Keunggulan Layanan</p>
      ...
      <div className="grid grid-cols-12 gap-4 md:gap-6">
        {values.map((v) => (
          <div key={v.title} className="col-span-12 sm:col-span-6 md:col-span-3">
            <div className="group relative overflow-hidden rounded-xl border border-zinc-800 bg-card/40 p-5 transition hover:border-[#D4AF37]/70 hover:shadow-lg">
