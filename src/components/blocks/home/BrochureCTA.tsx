...
export default function BrochureCTA() {
  ...
  return (
    <section className="mx-auto max-w-[1200px] px-4 md:px-8 xl:px-12 py-12 lg:py-20">
      <div className="rounded-2xl border border-amber-500/40 bg-gradient-to-b from-amber-500/10 to-amber-600/5 p-6 md:p-8">
        ...
        <p className="mt-2 text-sm md:text-base text-amber-200/90">
        ...
        <div className="mt-4">
          ...
          <a
            href={brochureHref}
            className="inline-flex items-center gap-2 rounded-xl border border-amber-500/50 bg-amber-500/15 px-4 py-2 text-sm font-medium text-amber-200 hover:bg-amber-500/25 transition"
          >
            Unduh PDF
